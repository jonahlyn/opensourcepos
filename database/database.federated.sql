...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='master_customer/ospos_customers';
...
CREATE TABLE `ospos_people` (
  ...
  KEY `email` (`email`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='master_customer/ospos_people';
...
CREATE TABLE IF NOT EXISTS `ospos_customers_points` (
  ...
  KEY `package_id` (`package_id`),
  KEY `sale_id` (`sale_id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 CONNECTION='master_customer/ospos_customers_points';
